...
const GamesSection = () => {
	const initialGames = useMemo(() => [
		...
		{ title: "CoinFlip", slug: "coin-flip", image: "https://res.cloudinary.com/dma1c8i6n/image/upload/v1754055244/20250711_0455_Suspenseful_Coinflip_Casino_remix_01jzvk1a6tfdabsantqec6vp1m_af9xug.png" },
